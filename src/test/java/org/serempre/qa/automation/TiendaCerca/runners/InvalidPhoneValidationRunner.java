...
@CucumberOptions(
features="src\\test\\resources\\features\\InvalidPhoneValidation.feature",
...
,tags="@SignUpWithInvalidPhone,@SignUpWithInvalidPhone2" //etiquetas definida en el feature que se desea ejecutar

)
public class InvalidPhoneValidationRunner {
	...
	public static void test() throws InvalidFormatException, IOException {//metodo para modificar el feature con los datos del documento excel
		DataToFeature.overrideFeatureFiles(".\\src\\test\\resources\\features\\InvalidPhoneValidation.feature");	
	}
