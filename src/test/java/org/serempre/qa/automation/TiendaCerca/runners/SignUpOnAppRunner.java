...
@CucumberOptions(features="src\\test\\resources\\features\\SignUpOnApp.feature",
...
,tags="@SignUpSuccessfully" //etiquetas definida en el feature que se desea ejecutar

)

public class SignUpOnAppRunner {
	...
	public static void test() throws InvalidFormatException, IOException {//metodo para modificar el feature con los datos del documento excel
		DataToFeature.overrideFeatureFiles(".\\src\\test\\resources\\features\\SignUpOnApp.feature");	
	}
